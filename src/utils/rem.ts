export default () => {
  ...
  function setRem() {
      ...
      document.documentElement.style.fontSize = ((16/9*document.body.clientHeight) / 100).toFixed(5) + "px";
  }
}
...
export function fontSizeHeight(size:number){
return (size*document.body.clientHeight / 1080);
}
